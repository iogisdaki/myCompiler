...
{
       0,    42,    42,    51,    56,    59,    60,    61,    62,    63,
      66,    74,    80,    88,    95,   101,   107,   108,   112,   118,
     119,   125,   133,   134,   140,   148,   149,   155,   163
};
#endif
...
#line 66 "myparser.y"
        ...
        insertSymbol((yyvsp[-2].string));  // insert into the symbol table
    }
#line 1205 "myparser.tab.c"
    break;
